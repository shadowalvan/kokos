...
.team-member {
  ...
  box-shadow: 0 4px 8px rgba(0, 0, 0, 0.08); /* Subtle shadow for definition */
}
...
.member-photo {
  ...
  border: 4px solid #fd8804; /* Secondary Orange for the photo border */
}
...
.member-role {
  color: #fd8804; /* Secondary Orange for the role text */
  font-weight: 600;
  margin-bottom: 1rem;
}
